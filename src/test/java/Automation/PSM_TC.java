...
import Alerts_Mailer.PSM_Mailer;
...
public class PSM_TC extends BaseTest {

	private PSM_Mailer psm;
...
//    softAssert.assertAll();
	 ...
	 @Test(priority = 7,enabled = false, description = "Verify Unsubscribe CTA redirection")
	    public void Verify_Unsubscribe_CTA_redirection() {
	        ...
	        PropertyRedirectionResult result = psm.click_Unsubscribe();
